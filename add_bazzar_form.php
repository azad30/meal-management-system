    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
				  <h3>Select member and add money (Bazar)</h3>
				  <form method="POST" action="">
					   <?php
							if(isset($_POST['submit'])){
							  ...
							  $register = "INSERT INTO bazar_money(amount,create_date,member_id) VALUES ('$amount','$date','$memberid')";
							  $result   = mysqli_query($connect,$register);
							  echo "<div class='alert alert-success'>
						  <strong>Success!</strong> Thank you.
						</div>";
echo "<script>setTimeout(\"location.href = 'bazar_money.php';\",1500);</script>";
